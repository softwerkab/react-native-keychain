...
RCT_EXPORT_METHOD(setGenericPasswordForOptions:(NSDictionary *)options withUsername:(NSString *)username withPassword:(NSString *)password resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  [Bugsnag leaveBreadcrumbWithBlock:^(BugsnagBreadcrumb *crumb) {
    crumb.name = @"RNKeychainManager";
    crumb.type = BSGBreadcrumbTypeLog;
    
    crumb.metadata = @{
                       @"message": [NSString stringWithFormat:@"setGenericPassword(opts: {%@}) called SecItemDelete", options[@"accessible"]],
                       @"response": @(osStatus),
                       };
  }];
  ...
  [Bugsnag leaveBreadcrumbWithBlock:^(BugsnagBreadcrumb *crumb) {
    ...
    crumb.metadata = @{
                       @"message": [NSString stringWithFormat:@"setGenericPassword(opts: {%@}) called SecItemAdd", options[@"accessible"]],
                       @"response": @(osStatus),
                       };
  }];
...
RCT_EXPORT_METHOD(getGenericPasswordForOptions:(NSDictionary *)options resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  [Bugsnag leaveBreadcrumbWithBlock:^(BugsnagBreadcrumb *crumb) {
    ...
    crumb.type = BSGBreadcrumbTypeLog;
    crumb.metadata = @{
                       @"message": @"getGenericPasswordForOptions called SecItemCopyMatching",
                       @"response": @(osStatus),
                       };
  }];
